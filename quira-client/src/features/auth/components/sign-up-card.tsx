...
import {z} from 'zod'
import {useRegister} from "@/app/api/query-hooks/useAuth.tsx";
...
const formSchema = z.object({
    ...
    last_name: z.string().trim()
        .min(2, {message: 'Фамилия должно быть не менее 5 символов'})
        .max(50, {message: 'Фамилия должно быть не более 250 символов'}),
    password: z.string()
